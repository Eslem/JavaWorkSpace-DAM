...
public class VentanaPrincipal extends JFrame implements ActionListener{
    ...
    public VentanaPrincipal() {
        ...
        textoIntroduccion = "Esta aplicación presenta un ejemplo práctico del patron "
                        ...
                        "tambien son vinculados algunos conceptos de los Patrones Value Object, Data Access Objetc, Transfer Object y Singleton.\n";

        areaIntroduccion = new JTextArea();
        areaIntroduccion.setBounds(50, 90, 380, 150);
    ...
    public void actionPerformed(ActionEvent e) {
        if (e.getSource()==botonRegistrar) {
            miControlador.mostrarVentanaPersona();			
        }
